...
uint32_t    get_gy_521_who_am_i(uint8_t* who_am_i)
{
    ...
    i2c_isr_err_occured = i2c_read(I2C1, (uint16_t)(I2C_SLAVE_ADDR_AD1), WHO_AM_I,  who_am_i, 1);
...
uint32_t    wakeup_from_sleep()
{
    ...
    i2c_isr_err_occured = i2c_write(I2C1, (uint16_t)(I2C_SLAVE_ADDR_AD1), PWR_MGMT_1, 0x00);
    return (i2c_isr_err_occured);
}
